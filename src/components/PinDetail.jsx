...
const PinDetail = ({ user }) => {
  ...
  return (
    ...
    <div
      ...
      style={{ maxWidth: '1500px', borderRadios: '32px' }}
    >
      ...
      <div className='w-full p-5 flex-1 xl:min-w-620'>
        <div className='flex items-center justify-between'>
          ...
          <a href={pinDetail.destination} target="_blank" rel='noreferrer'>{pinDetail.destination.length > 25
                    ? `${pinDetail.destination.slice(0, 25)}...`
                    : pinDetail.destination}</a>
        </div>
        <div>
      ...
      >
        ...
        <input type="text"
         ...
         className='flex-1 border-gray-400 outline-none border-2 p-2 rounded-2xl focus:border-gray-300'/>
         <button
          type='button'
    ...
    {pins ? (
      ...
      <Spinner message={"Loading for pins"}></Spinner>
    )}
    </>
  );
};
