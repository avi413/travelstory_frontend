...
import { BsDashCircle, BsFillArrowUpRightCircleFill } from 'react-icons/bs';
import { client, cliten, urlFor } from '../container/client';
...
const Pin = ({ pin: { postedBy, image, _id, destination, save } }) => {
  ...
  const alreadySaved = save && !!save?.filter((item) => item.postedBy._id === user?.sub)
    ?.length;
